...
<html lang="en">
  ...
  <div class="main-div">
    ...
    $sql = mysqli_query($conn, "SELECT * FROM activity_tbl A INNER JOIN senior_tbl S ON A.act_senior_id = S.senior_id INNER JOIN action_tbl AC ON A.action_id = AC.action_id WHERE act_senior_id IS NOT NULL");
